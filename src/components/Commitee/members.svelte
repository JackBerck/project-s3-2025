						...
						<div class="button-group">
							...
							{#if committee.instagram}
								<a
									...
									class="instagram extra-small-font-size"
								>
...
<style>
	...
	.slider .list .item .content .button-group {
		display: flex;
		gap: 0.5rem;
		margin-top: 1rem;
		flex-wrap: wrap;
	...
	.slider .list .item .content .instagram {
		display: inline-flex;
		align-items: center;
		gap: 0.5rem;
		padding: 0.5rem 1rem;
	...
	.slider .list .item .content .instagram:hover {
		background-color: rgba(255, 255, 255, 0.2);
		border-color: rgba(255, 255, 255, 0.4);
		transform: translateY(-2px);
	}

	.slider .list .item .content .instagram svg {
		width: 16px;
		height: 16px;
	}
