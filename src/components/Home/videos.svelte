	...
	<div class="container max-w-screen-xl">
		...
		>
			...
			<blockquote
				...
				data-instgrm-permalink="https://www.instagram.com/reel/C-R_ZttPxVZ/?utm_source=ig_embed&amp;utm_campaign=loading"
			...
			>
				<div style="padding:16px;">
					<a
						href="https://www.instagram.com/reel/C-R_ZttPxVZ/?utm_source=ig_embed&amp;utm_campaign=loading"
					...
					>
						<a
							...
							target="_blank"
							>Sebuah kiriman dibagikan oleh Soedirman Student Summit 2025 (@soedirmanstudentsummit)</a
						>
					</p>
				</div>
			</blockquote>
