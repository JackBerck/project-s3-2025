...
<section id="events-home" class="section-padding-x text-light-base relative overflow-hidden py-0 md:py-12">
	...
	<div class="absolute left-0 z-10 h-96 xl:h-48 w-full bg-[#E23C64]" style="top: {candiHeight - 2}px"></div>
