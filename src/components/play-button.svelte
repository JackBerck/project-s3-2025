...
<button
	...
	class="audio-player-button text-light-base from-rose-s3-base to-yellow-s3-base fixed right-4 bottom-4 z-80 flex transform cursor-pointer items-center justify-center rounded-full bg-gradient-to-br p-3 shadow-lg transition-all duration-300 outline-none hover:scale-105 hover:shadow-xl {expanded
		? 'expanded'
		: 'collapsed'} {addClass}"
